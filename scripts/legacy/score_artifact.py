...
用法:
    python scripts/legacy/score_artifact.py --stage 1 --critique state/critique_v0.json
    python scripts/legacy/score_artifact.py --competition mcm --task-type A_continuous --stage 3 --critique c.json
    # stage 5 per-Qi 评分:
    python scripts/legacy/score_artifact.py --stage 5 --variant per_qi --qi-id Q1 --critique critique_q1_v0.json
    # stage 5 多 Qi 聚合:
    python scripts/legacy/score_artifact.py --stage 5 --mode aggregate_qi --qi-results qi_results.json
"""
